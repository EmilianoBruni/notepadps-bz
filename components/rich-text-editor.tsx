...
import { Bold, List, Palette, ChevronUp, X, Strikethrough, Settings2 } from "lucide-react"
      ...
      {isToolbarOpen && (
        <div className="border border-slate-300 rounded-lg overflow-hidden mb-1 bg-slate-50">
          <div className="flex items-center gap-2 p-2">
            ...
            <Select defaultValue="normal" onValueChange={(value) => execCommand("formatBlock", value)}>
